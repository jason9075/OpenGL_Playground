...
TestBVH::TestBVH(const float screenWidth, const float screenHeight) {
...
void TestBVH::OnEvent(SDL_Event &event) { camera->handle(event); }

void TestBVH::OnRender() {
